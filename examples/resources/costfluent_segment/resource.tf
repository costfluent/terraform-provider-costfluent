...
resource "costfluent_segment" "checkout_platform" {
  ...
  team_id     = costfluent_workspace.production.everyone_team_id
  product     = "Checkout"
  cost_centre = "CC-1001"
}
...
# The shared-cost bucket. Its cost is spread across direct segments in proportion to what they
# own, so it names no team, product or cost centre.
